    ...
    <ul>
      ...
      <li>
        <ul class="items-center">
          ...
          <li class="ml-[58px]"><a href="#">About</a></li>
          <li class="uk">
            <a href="#"><img src="../assets/uk.png" alt="" /></a>
          </li>
          <li class="lets">
            <a href="#">Let’s work</a>
          </li>
...
.lets {
  @apply bg-sec rounded-full py-[16px] ml-[10px] px-[32px] text-[#fff] h-[52px];
}
.uk {
  @apply h-[52px] ml-[91px] p-[10px] border-[rgba(0,0,0,0.1)] border-[2px] rounded-full;
}
</style>
